...
const HeroSection = () => {
  return (
    <div>
      <div class="h-24 z-50 relative container mx-auto px-6 grid grid-cols-3 hero1"></div>
      <div class="w-scrren h-24  bg-opacity-95 absolute top-0 left-0" />
      <div class="-mt-24 relative w-screen py-12 px-12">
        <div class="relative z-10 text-center py-24 md:py-48 h-[400px]">
            ...
            <div class="  font-black">
              ...
              <table className="table">
                <tr>
                  <td>
                    {" "}
                    <img src={googleLogo} alt="googleLogo" class="w-30 h-12" />
                  </td>
                  <td>
                    <img
                      src={appleLogo}
