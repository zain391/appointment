          ...
          <div className="flex flex-col md:flex-row max-w-7xl justify-center items-center ">
            <div className="overflow-hidden w-full m-4 shadow-sm flex flex-col md:flex-row justify-center">
              <div className="flex flex-col md:flex-row items-center">
                <div className=" w-full overflow-hidden"> <img src="https://source.unsplash.com/700x350/?city" alt="" className /> </div>
                <div className="md:w-2/3 m-4 ">
                  ...
                  <div className="flex cursor-pointer">
                    <div className="m-2"> <img src="https://source.unsplash.com/50x50/?man" alt="" className=" rounded-full" /> </div>
